...
- New `zip: explicit subdir takes the filename verbatim` suite
  ...
  round-trip, traversal rejection); wrapper file compile-verified
  with `hbmk2`.
...
- `openads-1.09.61-windows-x64.zip`
- `openads-1.09.61-windows-x86.zip`
- `openads-1.09.61-linux-x64.tar.gz`
- `openads-1.09.61-macos-universal.tar.gz`
