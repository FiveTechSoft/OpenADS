...
UNSIGNED32 ENTRYPOINT oads_CheckExistence( ADSHANDLE hConnect,
                                           UNSIGNED8 *pucName,
                                           UNSIGNED16 *pbExists )
{
...
UNSIGNED32 ENTRYPOINT oads_DeleteFile( ADSHANDLE hConnect,
                                       UNSIGNED8 *pucName )
{
    return AdsDeleteFile( hConnect, pucName );
}

UNSIGNED32 ENTRYPOINT oads_RenameFile( ADSHANDLE hConnect,
                                       UNSIGNED8 *pucOld,
                                       UNSIGNED8 *pucNew )
{
...
UNSIGNED32 ENTRYPOINT oads_GetFileSize( ADSHANDLE hConnect,
                                        UNSIGNED8 *pucName,
                                        UNSIGNED32 *pulSize )
{
...
UNSIGNED32 ENTRYPOINT oads_GetFileTime( ADSHANDLE hConnect,
                                        UNSIGNED8 *pucName,
                                        UNSIGNED8 *pucTime,
                                        UNSIGNED16 *pusLen )
{
...
UNSIGNED32 ENTRYPOINT oads_GetFileDate( ADSHANDLE hConnect,
                                        UNSIGNED8 *pucName,
                                        UNSIGNED8 *pucDate,
                                        UNSIGNED16 *pusLen )
{
...
UNSIGNED32 ENTRYPOINT oads_DirMake( ADSHANDLE hConnect,
                                    UNSIGNED8 *pucPath )
{
    return AdsDirMake( hConnect, pucPath );
}

UNSIGNED32 ENTRYPOINT oads_DirRemove( ADSHANDLE hConnect,
                                      UNSIGNED8 *pucPath )
{
    return AdsDirRemove( hConnect, pucPath );
}

UNSIGNED32 ENTRYPOINT oads_DirExist( ADSHANDLE hConnect,
                                     UNSIGNED8 *pucPath,
                                     UNSIGNED16 *pbExists )
{
...
UNSIGNED32 ENTRYPOINT oads_Directory( ADSHANDLE hConnect,
                                      UNSIGNED8 *pucMask,
                                      UNSIGNED16 usAttr,
                                      UNSIGNED8 *pucBuffer,
